...
## 2. Le Projet et l'Équipe

### Genèse

Le projet démarre en 2019 quand **Ali Ben Hamoud**, après des études de pétrochimie en Chine, découvre une technologie brevetée de récupération des vapeurs d'essence. Un prototype est installé en septembre 2019 à la station AGIL de la Cité Olympique (Tunis), avec l'accord technique de la SNDP. Les résultats sont validés par un cabinet externe indépendant.
...
**GEKO** (Corée du Sud) — fabricant exclusif :
- Usine certifiée ISO
- Soutien académique : Institut de Réfrigération et de Génie Cryogénique, Université de Tongji
- Laboratoire ENCONGLOBAL (Autorité de Corée)
- Machines fabriquées en acier inoxydable 304
...
Les carburants sans plomb sont hautement volatils. Lors du déchargement des camions-citernes, du stockage et du ravitaillement des véhicules, une quantité significative d'essence se transforme en gaz — les **Composés Organiques Volatils (COV)**. Ces émissions représentent :

- Une **pollution atmosphérique** grave (ozone troposphérique, smog, risques sanitaires)
- Des **pertes financières directes** pour la station (entre 3 et 7 litres perdus par 1 000 litres vendus)

En Tunisie, **aucune norme** n'impose actuellement de limiter ces émissions, contrairement aux directives européennes Phase I et II.

### La solution : ECO-RENTABLE

L'équipement s'installe en **circuit fermé** sur les cuves souterraines de la station, sans fermeture ni travaux :

```
Cuve → Capteurs de pression → Aspiration des vapeurs
     → Liquéfaction par condensation frigorifique
     → Stockage interne → Réinjection dans la cuve
```

**Cycle automatique complet :**
1. La pression dans la cuve dépasse le seuil prédéfini
2. La machine s'enclenche automatiquement
3. Les vapeurs sont aspirées et liquéfiées
4. L'essence récupérée est réinjectée dans la cuve
5. Arrêt automatique au retour au seuil nominal
6. Toutes les données sont accessibles en temps réel via l'application dédiée

### Caractéristiques techniques

| Paramètre | Valeur |
|---|---|
| Capacité de traitement | 80 m³/h de gaz |
| Matériaux | Acier inoxydable 304 |
| Consommation électrique | 4 kW |
| Certifications | ATEX (anti-explosion), ISO usine |
| Durée de vie garantie | ≥ 10 ans |
| Installation | 24h, sans arrêt de la station |
| Connectivité | Application dédiée, accès temps réel (gérant + HCTECH + GEKO) |

### Résultats du prototype (station AGIL, Cité Olympique, 2019)

- Efficacité de récupération confirmée
- Taux de récupération validé entre **3/1000 et 7/1000** (certifié cabinet externe)
- Zéro panne, zéro bug applicatif
- Données application identiques aux mesures physiques de la station
- La SNDP a émis une décision interne encourageant ses gérants à s'équiper, avec cofinancement à hauteur de 27 000 DT par machine
...
- **Renouvellement :** option de reconduction ou rachat de la machine par la station à valeur résiduelle

---

## 5. Le Marché

### Marché primaire — Tunisie

**~900 stations-service** réparties sous 5 enseignes principales :

| Enseigne | Stations | Type de décision achat |
|---|---|---|
| AGIL (SNDP) | 280 | Kiosque par kiosque (filiale SAGES : 20 stations, décision directe) |
| Total Energies | 185 | Centrale (head-quarters) |
| OLA Energy | 178 | Centrale |
| Vivo Shell | 167 | Centrale |
| Staroil | 95 | Mixte |
| **Total** | **905** | |
